...
<?php
	...
	if (isset($_POST['submit'])) {
		...
		if (empty($_POST['username']) || empty($_POST['password']) || $_POST['country']=='select country:' || $_POST['password']!=$_POST['confirm_password'])
	 	{
			$error = true;
			$message = 'Please make sure all info is filled in and valid.';
		}	
